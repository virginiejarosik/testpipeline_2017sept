 ...
 */
$field_featured_image = render($content['field_image']);
?>
<?php print $field_featured_image ? '<figure>' . l(render($content['field_image']), 'node/' . $node->nid, array('html' => true)) . '</figure>' : ''; ?>
<div class="text">
    <?php if(isset($content['field_main_category'])) { ?><h6><?php print render($content['field_main_category']); ?></h6><?php } ?>
