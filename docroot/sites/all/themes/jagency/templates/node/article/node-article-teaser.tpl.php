 ...
 */
$field_featured_image = render($content['field_main_image']);
?>
<?php print $field_featured_image ? '<figure>' . l(render($content['field_main_image']), 'node/' . $node->nid, array('html' => true)) . '</figure>' : ''; ?>
<div class="text">
