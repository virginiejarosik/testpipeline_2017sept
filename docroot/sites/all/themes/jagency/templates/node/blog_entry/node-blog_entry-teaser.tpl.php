 ...
 */
$field_featured_image = render($content['field_frontpage_image']);
?>
<?php print $field_featured_image ? '<figure>' . l(render($content['field_frontpage_image']), 'node/' . $node->nid, array('html' => true)) . '</figure>' : ''; ?>
<div class="text">
    <?php if(isset($content['field_default_color'])) { ?><h6><?php print render($content['field_default_color']); ?></h6><?php } ?>
