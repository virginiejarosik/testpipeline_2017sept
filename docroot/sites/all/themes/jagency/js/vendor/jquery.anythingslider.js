	...
	$.anythingSlider = function(el, options) {
		...
		base.slideControls = function(toggle){
			...
			if (o.buildArrows && o.toggleArrows) {
				...
				//base.$forward.stop(true,true).delay(t1).animate({ right: base.arrowRight + (sign * base.arrowWidth), opacity: op }, o.animationTime/1);
				//base.$back.stop(true,true).delay(t1).animate({ left: base.arrowLeft + (sign * base.arrowWidth), opacity: op }, o.animationTime/1);
				base.$forward.stop(true,true).delay(t1).animate({ opacity: op }, o.animationTime/1);
				base.$back.stop(true,true).delay(t1).animate({ opacity: op }, o.animationTime/1);
