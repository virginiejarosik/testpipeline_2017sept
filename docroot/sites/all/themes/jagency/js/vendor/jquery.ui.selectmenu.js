...
$.widget("ui.selectmenu", {
  ...
  _create: function() {
    ...
    // make / set unique id
    if (typeof(this.element.uniqueId) == "undefined") return;
    ...
    this.newelement.prepend( '<span class="ui-selectmenu-status ui-selectmenu-text" />' );
  ...
  destroy: function() {
    this.element.removeData( this.widgetName )
      ...
      .unbind( ".selectmenu" );
    if (typeof(this.ids) == "undefined") return;
